...
#define LIDAR_CMD_GETPARAM                  0x70
...
//! A struct for returning configuration from the CSPC LIDAR
struct LaserConfig {
  //! Start angle for the laser scan [rad].  0 is forward and angles are measured clockwise when viewing CSPC LIDAR from the top.
  float min_angle;
  //! Stop angle for the laser scan [rad].   0 is forward and angles are measured clockwise when viewing CSPC LIDAR from the top.
  float max_angle;
